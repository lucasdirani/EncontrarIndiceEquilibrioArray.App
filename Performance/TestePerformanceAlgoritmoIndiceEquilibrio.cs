...
using EncontrarIndiceEquilibrioArray.App.Algoritmos;

namespace EncontrarIndiceEquilibrioArray.App.Performance
{
    [MemoryDiagnoser]
    [RankColumn]
    public class TestePerformanceAlgoritmoIndiceEquilibrio
    {
        [Params(
        ...
        [Benchmark]
        public void MedirPerformanceEncontrarIndiceDeEquilibrioEmComplexidadeQuadratica()
        {
            _ = AlgoritmoIndiceEquilibrio.EncontrarIndiceDeEquilibrioEmComplexidadeQuadratica(Array, Array.Length);
        }

        [Benchmark]
        public void MedirPerformanceEncontrarIndiceDeEquilibrioEmComplexidadeLinear()
        {
            _ = AlgoritmoIndiceEquilibrio.EncontrarIndiceDeEquilibrioEmComplexidadeLinear(Array, Array.Length);
        }
    }
}